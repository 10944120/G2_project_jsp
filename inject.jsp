    ...
    <section>
        <div class="item">
            <div class="item-photo">
                 <img src="../assets/images/inject.png">
            </div>
        <!--    <div class="item-tit">
                 <h1>消脂針</h1>
            </div>
            <div class="item-intro">
                <p>欸…這是雙下巴還是游泳圈，是不是該來消個脂？</p>
           </div>-->
<% 
...
%>
    ...
    <section>
        <div class="write">
            <form action="board4.jsp" method="post" id="message" name="留言">
                <div>
...
%>
        <!--<div class="message-ex">
                 ...
                 <div class="message-ex-txt"><p>完美的下顎線</p></div>
            </div>
            <div class="message-ex">
                 ...
                 <div class="message-ex-txt2"><p>脖子輕鬆好多</p></div>
            </div>-->
        </div>
    </section>
    <script>
