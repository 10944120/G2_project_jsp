...
%>
    ...
    <section>
        <div class="write">
            <form action="board3.jsp" method="post" id="message" name="留言">
                <div>
...
%>
        <!--<div class="message-ex">
                 ...
                 <div class="message-ex-txt"><p>我又年輕了10歲</p></div>
            </div>
            <div class="message-ex">
                 ...
                 <div class="message-ex-txt2"><p>白泡泡幼綿綿</p></div>
            </div>-->
        </div>
    </section>
    <script>
