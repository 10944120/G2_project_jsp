    ...
    <section>
        <div class="item">
            <div class="item-photo">
                 <img src="../assets/images/breast.png">
            </div>
        <!--<div class="item-tit">
                 <h1>隆乳</h1>
            </div>
            <div class="item-intro">
                <p>愛生氣的你，隆了乳就不易生氣，因為胸部起來！</p>
            </div>-->
...
%>
    ...
    <section>
        <div class="write">
            <form action="board2.jsp" method="post" id="message" name="留言">
                <div>
...
%>
        <!--<div class="message-ex">
                 ...
                 <div class="message-ex-txt"><p>上半身好重好喜歡</p></div>
            </div>
            <div class="message-ex">
                 ...
                 <div class="message-ex-txt2"><p>我是最吸引男人眼球的嬯</p></div>
            </div>-->
        </div>
    </section>
    <script>
