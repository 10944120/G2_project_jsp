    ...
    <section>
        <div class="item">
            <div class="item-photo">
                 <img src="../assets/images/nose.png">
            </div>
        <!--    <div class="item-tit">
                 <h1>隆鼻</h1>
            </div>
...
%>
    ...
    <section>
        <div class="write">
            <form action="board6.jsp" method="post" id="message" name="留言">
                <div>
...
%>
        <!--<div class="message-ex">
                 ...
                 <div class="message-ex-txt"><p>吸到更多空氣了</p></div>
            </div>
            <div class="message-ex">
                 ...
                 <div class="message-ex-txt2"><p>眼鏡終於不會掉下來了</p></div>
            </div>-->
        </div>
    </section>
    <script>
